...
const EditBook = () => {
    ...
    useEffect(() => {
        getPublisherInfo(values.publisherId).then(res => setDefaultPublisher(res.name)).catch(err => console.log(err))
    }, [values.publisherId])
    ...
    useEffect(() => {
        getBookInfo(bookId).then(res => {
            ...
            getPublisherInfo(res.publisherId).then(res => setDefaultPublisher(res.name)).catch(err => console.log(err))
