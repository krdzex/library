...
const BooksDashboard = () => {
    ...
    const rows = allBooks.map((book, id) => {
        return { id: id + 1, title: publisher.name, pages: publisher.address.country,pages: publisher.address.country, _id: publisher._id }
    })

    const columns = [
        { field: 'id', headerName: 'ID', width: 70 },
        {
            field: 'firstName', headerName: 'Title', flex: 1,
