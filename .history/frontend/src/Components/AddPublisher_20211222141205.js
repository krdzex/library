...
const AddPublisher = () => {
    ...
    return (
        <div>
            <Header />
            <Container maxWidth="sm" component="form" sx={{ mt: 12, mb: 5 }}>
                <Paper variant="outlined" sx={{ my: { xs: 3, md: 6 }, p: { xs: 2, md: 3 } }}>
                    <Typography variant='h2' mb={3}>Add Publisher</Typography>
                    <Grid container spacing={3}  onSubmit={onSubmit}>
                        <Grid item xs={12}>
                            <TextField
                                required
                                type="text"
                        ...
                        <Grid item xs={12} sm={6}>
                            <Button type='submit' variant="contained" component="span" fullWidth className={classes.button}>
                                Go back
                            </Button>
                        </Grid>
