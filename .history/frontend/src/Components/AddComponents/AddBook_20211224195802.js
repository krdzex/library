...
const AddBook = () => {
    ...
    const onSubmit = (e) => {
        ...
        formData.append("pages", values.level)
        formData.append("price", values.duration)
        formData.append("img", values.level)
        formData.append("publisherId", values.duration)
    }
                        ...
                        <Grid container spacing={5} alignItems="flex-start">
                            ...
                            >
                                ...
                                <label htmlFor="contained-button-file" >
                                    <Input accept="image/*" id="contained-button-file" multiple type="file" sx={{ display: "none" }} onChange={onChangeFile}/>
